...
async function evalToDB(rating: number, comment: string, id: string, router: any) {
...
const evaluationForm = () => {
    ...
    <SafeAreaView style={styles.mainView}>
        ...
        <TouchableOpacity style={styles.button} onPress={() => evalToDB(sliderVal, comment, id, router)}>
